package com.mrray.datadesensitiveserver.config;
...
@EnableJpaRepositories(
        basePackages = "com.mrray.datadesensitiveserver.repository",
...
public class JpaConfiguration {
    ...
    LocalContainerEntityManagerFactoryBean localContainerEntityManagerFactoryBean(@Qualifier(value =
        ...
        return builder.dataSource(dataSource)
                .packages("com.mrray.datadesensitiveserver.entity.domain")
